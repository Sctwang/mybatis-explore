...
public class XMLTest {
    ...
    public static void main(String[] args) throws IOException {
      ...
      /*
        key的结构
        -1885415485:2692716209:top.jonas.mybatis.mapper.UserMapper.queryById:0:2147483647:select
       ...
       */
        ...
        //方式一  可创建二级缓存
        User user = session.selectOne("top.jonas.mybatis.mapper.UserMapper.queryById", 1);
